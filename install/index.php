...
else if($s == 3)
{
	...
	if($_POST['s'] == 3)
	{
		...
		if($conn)
		{
			...
			INSERT INTO `#@__webconfig` VALUES('1','cfg_max_file_sizep','上传文件大小（数值的单位是字节b）','1','string','2097152','26');
			INSERT INTO `#@__webconfig` VALUES('1','cfg_max_file_sizeparr','上传文件大小（数值的单位是字节b）','1','string','2097152','26');
